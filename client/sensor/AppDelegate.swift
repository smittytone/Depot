...
// MARK: - Globals accesed from C code
...
class AppDelegate: NSObject, NSApplicationDelegate, NSAnimationDelegate {
    ...
    func applicationWillTerminate(_ aNotification: Notification) {
        ...
        // Halt the timaer and any animations still playing
    ...
    @objc private func doSelectBoard(_ sender: Any) {
        ...
        // Can't change horses mid-course, so warn ther user and bail
        if self.hasStarted {
    ...
    /**
     ...
     - Parameters:
        - heanimationad: The animation that has ended.
